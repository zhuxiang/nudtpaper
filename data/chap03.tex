...
Nemhauser等人证明了朴素的贪心算法得出解以$1-1/e$的因子近似于最优解，即任意一个由贪心算法的出来的解$S$都满足$I\left(S\right) \geq (1-1/e) I\left(S^{\ast}\right)$，其中$S^{\ast}$代表最优解。虽然贪心算法的核心思想比较简单，但是由于计算影响力期望值的过程是\#P-hard\upcite{Chen2010Scalable}的问题，因此实现该算法并不是简单的。
